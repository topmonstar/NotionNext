...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '3d5ba185d2de4ccba9fcabc6a0762586',
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '鲁ICP备2024080410号', // 备案号 闽ICP备XXXXXXX
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || LX1JFLRWI6, // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || 1c29d5944785158fd0ae569933bc321a, // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_SEARCH_ONLY_APP_KEY:
    process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_ONLY_APP_KEY || e194942a7997fc6fc84a881d4403739c, // 客户端搜索用的KEY
  ALGOLIA_INDEX: process.env.NEXT_PUBLIC_ALGOLIA_INDEX || 986211, // 在Algolia中创建一个index用作数据库
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'twik.986211.xyz', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  ANALYTICS_ACKEE_TRACKER:
    process.env.NEXT_PUBLIC_ANALYTICS_ACKEE_TRACKER || 'https://analytics.986211.xyz/tracker.js', // e.g 'https://ackee.tangly1024.com/tracker.js'
  ANALYTICS_ACKEE_DATA_SERVER:
    process.env.NEXT_PUBLIC_ANALYTICS_ACKEE_DATA_SERVER || 'https://analytics.986211.xyz', // e.g https://ackee.tangly1024.com , don't end with a slash
  ANALYTICS_ACKEE_DOMAIN_ID:
    process.env.NEXT_PUBLIC_ANALYTICS_ACKEE_DOMAIN_ID || '5f8eb036-f4ae-4d35-ad1c-7de2322f5f4e', // e.g '82e51db6-dec2-423a-b7c9-b4ff7ebb3302'
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || kddbp9j261, // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
