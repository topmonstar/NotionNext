...
const BLOG = {
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || 'ca-pub-5978864483368280', // Remove the value or replace it with your own google site verification code
